...
| `docs/praroc-paradigm.md` | The Progressive RAROC paradigm in full — reference doctrine behind `HORIZONS.md`: position sets and split signals, cases (codebase, role, enterprise), mnemonic, distilled rules. Copied for reference; never instantiated. |
