...
| `docs/resonance-matrix.md` | The Conditional Resonance Matrix in full — Owner-supplied canonical prose behind `HORIZONS.md` Conditional commitments: system-state transitions (False-Latent → State Change → True-Resonance → False-Decay), the "Yes, when" activation protocol, the funnel of reality, engineering for graceful entropy. Copied for reference; never instantiated. |
