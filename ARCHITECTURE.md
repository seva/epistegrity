...
Enforced at audit (METHODOLOGY.md Post-Phase Audit, item 4). Deviations must be declared in `CLAUDE.md` Conventions with rationale — undeclared violations are gaps.
